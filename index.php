...
<html><head>
    ...
    <base href="http://localhost:8080/SI penyakit ikan Gurami/SI-Penyakit-Gurami/">
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	  <link rel="icon" href="gambar/admin/log.jpg">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i> SR </b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>  SI-Rami </b></span>
        </a>
        <!-- Header Navbar -->
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="gambar/admin/log.jpg" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                      <span class="hidden-xs"><?php echo $user; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        <img src="gambar/admin/log.jpg" class="img-circle" alt="User Image">
                        <p>
